// URL de la API
const jsonUrl = 'https://reoobot.github.io/LibrosAfiliados/libros.json';
const imageBaseUrl = 'https://reoobot.github.io/LibrosAfiliados/'; // Base URL para las imágenes
