// URL de la API
const jsonUrl = 'https://reoobot.github.io/BibliaAfiliados/biblia.json';
const imageBaseUrl = 'https://reoobot.github.io/BibliaAfiliados/'; // Base URL para las imágenes
