// URL de la API
const jsonUrl = 'https://reoobot.github.io/GorrasAfiliados/gorras.json';
const imageBaseUrl = 'https://reoobot.github.io/GorrasAfiliados/'; // Base URL para las imágenes
